...
describe VillasController do
  ...
  describe "GET index" do
    it "assigns all villas as @villas" do
      ...
      assigns(:villas).should eq([villa])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new villa as @villa" do
      ...
      assigns(:villa).should be_a_new(Villa)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created villa as @villa" do
        post :create, {:villa => valid_attributes}, valid_session
        assigns(:villa).should be_a(Villa)
        assigns(:villa).should be_persisted
      end

      it "redirects to the created villa" do
        post :create, {:villa => valid_attributes}, valid_session
        response.should redirect_to(Villa.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved villa as @villa" do
        ...
        Villa.any_instance.stub(:save).and_return(false)
        post :create, {:villa => {}}, valid_session
        assigns(:villa).should be_a_new(Villa)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested villa" do
        villa = Villa.create! valid_attributes
        # Assuming there are no other villas in the database, this
        # specifies that the Villa created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Villa.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => villa.to_param, :villa => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the villa" do
        villa = Villa.create! valid_attributes
        put :update, {:id => villa.to_param, :villa => valid_attributes}, valid_session
        response.should redirect_to(villa)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the villa as @villa" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Villa.any_instance.stub(:save).and_return(false)
        put :update, {:id => villa.to_param, :villa => {}}, valid_session
        assigns(:villa).should eq(villa)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the villas list" do
      villa = Villa.create! valid_attributes
      delete :destroy, {:id => villa.to_param}, valid_session
      response.should redirect_to(villas_url)
    end
  end
